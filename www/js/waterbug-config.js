...
var elementPadding = 30; // padding around the logo and credit text

// logo configuration
// the name of the logo object should match the value of the corresponding radio button in the HTML.
var logos = {
    'lunchbox': {
        whitePath: '../img/OPB_white_waterbug.svg', // path to white logo
        blackPath: '../img/OPB_black_waterbug.svg', // path to black logo
        w: 150, // width of logo
        h: 50, // height of logo
        display: 'Lunchbox'
    }
